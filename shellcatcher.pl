...
system('cls');
system('title Shell Catcher ');
system "color 0a";
print"\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\t>              SHELL CATCHER 1.0               >\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\t>       _   _   _____   _       _              >\n";
print "\t>      | | | | | ____| | |     | |             >\n";
print "\t>      | |_| | |  _|   | |     | |             >\n";
...
print "\t>---------------------------------------------->\n";
print "\t>             Hell Crew Hacking                >\n";
print "\t>                                              >\n";
print "\t>   [Mergen - Weewx - Tinsimth All Brothers]   >\n";
print "\t>                                              >\n";
print "\t>              Author : Mergen                 >\n";
print "\t>                                              >\n";   
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
...
print "\n";
print " Enter site source code and scanning the System\n\n 1 = php\n 2 = asp\n 3 = aspx\n 4 = cfm\n 5 = js\n 6 = cgi\n 7 = brf\n\n shellcatcher> ";
$code=<STDIN>;
chomp($code);
...
print "shellcatcher> Target: $site\n";
print "shellcatcher> Site source code: $code\n";
print "shellcatcher> Searching shehll...\n\n\n";
